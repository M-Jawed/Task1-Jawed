...
export default function Landing(){
    ...
    return (
        <main id='landing' className='relative h-screen w-[100%] flex items-center flex-col '>
            ...
            <div className='w-[70%] flex items-center justify-between absolute top-[310px] z-20'>
            ...
            <div className='relative z-20 mt-[150px] text-center w-[650px] flex flex-col items-center'>
                <h1 className='text-white text-2xl font-semibold mb-[20px]'>Startup 3</h1>
                <h1 className='text-white text-6xl font-semibold mb-[20px]'>Forget About Code</h1>
                <p className='text-white text-xl mb-[50px]'>Startup Framework gives you complete freedom over your creative process — you don't have to think about any technical aspects. There are no limits and absolutely no coding. </p>
